...
class MoonPhaseServiceMock {
    ...
    getAthenianDate(date) {
        ...
        // THIS MIGHT BE THE ISSUE: simple division
...
console.log('--- Checking Aug 14 to Sep 13 Range ---');
let d = new Date('2026-08-14T12:00:00');
const endDate = new Date('2026-09-14T12:00:00');
